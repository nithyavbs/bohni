...
CREATE TABLE `admin_users` (
  ...
  KEY `category_id_fk3_idx` (`category_id`),
  CONSTRAINT `category_id_fk2` FOREIGN KEY (`category_id`) REFERENCES `business_categories` (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `business_sellers` (
  ...
  CONSTRAINT `category_name_fk2` FOREIGN KEY (`category_name`) REFERENCES `business_categories` (`category_name`),
...
CREATE TABLE `business_services` (
  ...
  CONSTRAINT `category_name_fk5` FOREIGN KEY (`category_name`) REFERENCES `business_categories` (`category_name`),
...
CREATE TABLE `expense` (
  ...
  KEY `service_id_fk_idx` (`services_id`),
  CONSTRAINT `seller_id_fk` FOREIGN KEY (`seller_id`) REFERENCES `business_sellers` (`seller_id`),
  CONSTRAINT `service_id_fk` FOREIGN KEY (`services_id`) REFERENCES `business_services` (`service_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  UNIQUE KEY `category_id_UNIQUE` (`category_id`),
  KEY `category_id_fk_idx` (`category_id`),
  KEY `service_id_fk1_idx` (`survice_id`),
  KEY `sellers_id_fk1_idx` (`sellers_id`),
  KEY `user_id_fk1_idx` (`user_id`),
  CONSTRAINT `category_id_fk1` FOREIGN KEY (`category_id`) REFERENCES `business_categories` (`category_id`),
  CONSTRAINT `sellers_id_fk1` FOREIGN KEY (`sellers_id`) REFERENCES `business_sellers` (`seller_id`),
  CONSTRAINT `service_id_fk1` FOREIGN KEY (`survice_id`) REFERENCES `business_services` (`service_id`),
...
CREATE TABLE `users` (
  ...
  `latitude` tinytext,
  `longtitude` tinytext,
  `business_photo` varchar(45) DEFAULT NULL,
  `shop_status` enum('small') DEFAULT NULL,
  `usertype` enum('small') DEFAULT NULL,
...
-- Dump completed on 2021-02-02 21:52:34
